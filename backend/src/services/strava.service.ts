...
export async function saveStravaActivity(userId: string, stravaActivity: Record<string, unknown>) {
  ...
  const data = {
    ...
    avgHeartRate: stravaActivity.average_heartrate != null ? Math.round(stravaActivity.average_heartrate as number) : null,
    maxHeartRate: stravaActivity.max_heartrate != null ? Math.round(stravaActivity.max_heartrate as number) : null,
    avgPower: stravaActivity.average_watts != null ? Math.round(stravaActivity.average_watts as number) : null,
